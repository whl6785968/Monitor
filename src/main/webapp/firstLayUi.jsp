							...
							<div class="layui-card">
								...
								<div class="layui-card-body">
                                    ...
                                    <!-- 为 ECharts 准备一个具备大小（宽高）的 DOM -->
                                    	  ...
                                    	  <div id="speedChartMain" style="width: 811px; height: 332px;position: relative;"></div>
									</div>
								</div>
							</div>
							<div class="layui-card">
								...
								<div class="layui-card-body">
                                    ...
                                    <!-- 为 ECharts 准备一个具备大小（宽高）的 DOM -->
						           	  ...
						           	  <div id="lineChartMain" style="width: 811px; height: 332px;position: relative;"></div>
									</div>
								</div>
							</div>
						</div>
									...
									<tr>
										...
										<td>
											<div class="layui-btn-container">
												<a class="layui-btn layui-btn-danger">你好</a>
												<a class="layui-btn">滚蛋</a>
											</div>
