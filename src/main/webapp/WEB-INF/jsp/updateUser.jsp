...
<body class="childrenBody">
	<form class="layui-form">
			...
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<input name="id" type="text" class="layui-input newsAuthor"
						id="mid" value="${id}" lay-verify="required" disabled="true" placeholder="请输入用户账号">
				</div>
			</div>
		</div>
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input id="mname" name="mname" value="${mname}" type="text" class="layui-input " lay-verify="required" placeholder="请输入姓名">
			</div>
		</div>
		<div class="layui-form-item">
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<input name="mdate" value="${mdate}" id="mdate" type="text" class="layui-input newsTime"
			...
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<select value="${auth}" id="auth" name="auth" class="newsLook" lay-filter="sel">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input id="email" name="email" value="${email}" type="text" class="layui-input " placeholder="请输入邮箱">
			</div>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label">联系方式</label>
			<div class="layui-input-inline">
				<input id="links" name="links" value="${links}" type="text" class="layui-input " placeholder="请输入联系方式">
			</div>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label">备注</label>
			<div class="layui-input-block">
				<textarea  name="others" value="${others}" class="layui-textarea layui-hide" 
